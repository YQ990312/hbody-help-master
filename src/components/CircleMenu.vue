  ...
  <div id="CircleMenu">
    <div :class="type" :animate="animate">
      ...
      <div class="oy-menu-group" :class="{ open: open }">
        <button
          class="oy-menu-btn btn-toggle pink"
        ...
        <div class="btn-list">
          <div
            class="oy-menu-item oy-menu-item_1 yellow"
            :class="AnimateClass"
          ...
          <div
            class="oy-menu-item oy-menu-item_2 purple"
            :class="AnimateClass"
          ...
          <div
            class="oy-menu-item oy-menu-item_3 green"
            :class="AnimateClass"
          ...
          <div
            class="oy-menu-item oy-menu-item_4 blue"
            :class="AnimateClass"
